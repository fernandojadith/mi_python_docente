...
class UsuarioResource(resources.ModelResource):
    # ✅ Nombre del Rol en vez de ID
    nombre_rol = fields.Field(
        attribute="id_rol",
        column_name="Rol",
        widget=ForeignKeyWidget(Rol, "tipos_de_rol")
    )
    ...
    class Meta:
        model = Usuario
        import_id_fields = ["id_usuario"]   # usamos el id_usuario como identificador
        fields = (
            "id_usuario",
            "nombre",
            "fecha_de_nacimiento",
            ...
            "numero_de_documento",
            "lugar_de_residencia",
            "nombre_programa",      # 👈 lo moví aquí, al lado de lugar_de_residencia
            "titulo_de_pregrado",
            "titulo_de_nivel_maximo",
            "tipo_de_vinculo",
            "fecha_de_ingreso",
            "nombre_rol",           # 👈 exporta/importa el nombre del rol
        )
        export_order = fields
